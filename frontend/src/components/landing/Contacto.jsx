...
const Field = ({ label, id, type = "text", value, onChange, testid }) => (
  <div className="group relative">
    <label
      htmlFor={id}
      className="font-mono-accent text-[10px] uppercase tracking-[0.25em] text-[#6B7280]"
    >
      {label}
    </label>
    <input
...
export const Contacto = () => {
  ...
  const submit = (e) => {
    ...
    toast.success("¡Gracias! Tu solicitud fue registrada. Te contactaremos pronto.");
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-6 max-w-md font-body text-base leading-relaxed text-[#9CA3AF]">
              Cuéntanos qué necesitas mover y diseñaremos la ruta. Respuesta en
              menos de 24 horas hábiles.
            </p>

            <div className="mt-12 flex flex-col gap-5">
              <a
                href="mailto:contacto@ferinfected.com"
                data-testid="contact-email"
                className="group flex items-center gap-4 text-white/80 transition-colors duration-300 hover:text-[#00E5FF]"
              >
                <Mail size={18} strokeWidth={1.5} />
                <span className="font-body">contacto@ferinfected.com</span>
              </a>
              <a
              ...
              <div className="flex items-center gap-4 text-white/80">
                ...
                <span className="font-body">Ciudad de México, México</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <button
                ...
                className="group mt-2 inline-flex w-fit items-center gap-3 rounded-full bg-[#00E5FF] px-8 py-4 font-mono-accent text-xs uppercase tracking-[0.2em] text-[#050505] transition-transform duration-300 hover:scale-[1.03]"
              >
                Enviar Solicitud
                <ArrowUpRight
                  size={16}
