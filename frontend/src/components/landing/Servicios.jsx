...
const SERVICES = [
  {
    ...
    desc: "Gestión aduanal, cumplimiento normativo y rutas internacionales optimizadas para mover electrónica entre mercados sin fricción.",
    icon: Globe,
    span: "lg:col-span-8",
    image:
  ...
  },
  {
    ...
    desc: "Entregas rápidas y trazables hasta el punto final, con visibilidad en tiempo real.",
    icon: Truck,
    span: "lg:col-span-4",
  },
  {
    n: "03",
    title: "Almacenamiento & Inventarios",
    desc: "Centros de distribución seguros y gestión inteligente de stock en tiempo real.",
    icon: Warehouse,
    span: "lg:col-span-4",
  },
  {
    ...
    desc: "Diseño de cadenas de suministro y estrategia comercial para escalar operaciones.",
    icon: LineChart,
    span: "lg:col-span-4",
  },
  {
    n: "05",
    title: "Comercialización & Intermediación",
    desc: "Conectamos fabricantes, mayoristas y retail con precios competitivos y volumen garantizado.",
    icon: Handshake,
    span: "lg:col-span-4",
  },
];
...
export const Servicios = () => {
  return (
    <section
      id="servicios"
      className="relative bg-[#050505] py-24 md:py-32"
        ...
        <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="max-w-2xl font-display text-4xl font-600 leading-[1] tracking-tighter text-white sm:text-5xl lg:text-6xl">
              Un ecosistema completo de distribución.
            </h2>
          </div>
          <p className="max-w-sm font-body text-base leading-relaxed text-[#9CA3AF]">
            Integramos cada eslabón de la cadena — del origen al consumidor —
            bajo una sola operación coordinada.
          </p>
        </div>
